...
void test_aes256ecb() {
    for(int i = 0; i < 10; ++i) {
        ...
        std::cout << "after  str: " << decode << std::endl;
        assert(str == decode);
    }
}
...
void test_one() {
    ...
    std::cout << to_hex(key) << std::endl;
    std::cout << sylar::base64encode(key) << std::endl;
    ...
    std::cout << "str: " << str << " len: " << str.size() << std::endl;
    std::cout << "encoded str: " << sylar::base64encode(encode) << " len: " << encode.size() << std::endl;
    std::cout << "encoded hex: " << to_hex(encode) << " len: " << encode.size() << std::endl;
    std::cout << "decoded str: " << decode << " len: " << decode.size() << std::endl;
